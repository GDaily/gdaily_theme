 ...
 <div class="relative">
 	<!-- 背景圖片使用img標籤以獲得更好的載入控制 -->
 	<img src="<?php echo get_template_directory_uri(); ?>/source/img/beams.webp"
 		alt="背景裝飾圖案"
 		class="absolute inset-0 w-full h-full object-cover -z-10"
 		fetchpriority="high"
 		loading="eager">

 	<div class="relative grid grid-cols-1 px-5 py-16 gap-y-10 gap-x-4 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3">
