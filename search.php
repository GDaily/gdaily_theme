...
<div style="background-image: url('<?php echo get_template_directory_uri(); ?>/source/img/beams.webp');">
    ...
    <div class="container px-5 py-8 mx-auto">
        ...
        <?php if (have_posts()) : ?>
            ...
            <!-- 調整關鍵字提示和搜尋框 -->
            <div class="p-6 mt-12 text-center rounded-lg bg-gray-50">
                ...
                <form role="search" method="get" action="<?php echo home_url('/'); ?>" class="max-w-md mx-auto">
                    <div class="flex">
                        <input type="search"
                            ...
                            autocomplete="off" />
                        <button type="submit"
                            class="px-6 py-3 text-white transition-colors bg-gray-600 rounded-r-lg hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">
                            搜尋
                        </button>
                    </div>
                </form>
        ...
        <?php else : ?>
            ...
            <div class="p-6 bg-white border rounded-lg shadow-sm">
                <h2 class="mb-4 text-xl font-semibold text-gray-800">重新搜尋</h2>
                <form role="search" method="get" action="<?php echo home_url('/'); ?>">
                    <div class="flex">
                        ...
                        <button type="submit" class="px-6 py-3 text-white bg-gray-600 rounded-r-lg hover:bg-gray-700">
                            搜尋
                        </button>
                    </div>
                </form>
